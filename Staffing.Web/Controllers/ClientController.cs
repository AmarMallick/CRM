...
namespace Staffing.Web.Controllers
{
    public class ClientController : Controller
    {
        ...
        #region Constructor
        public ClientController(ICompanyService companyService, ILOVService lOVService)
        {
        ...
        {
            int lovItemValueId = Convert.ToInt32(LovItemValue.Client);
            int total;
        ...
        public ActionResult CreateUpdateCompany(CompanyViewModel companyViewModel)
        {
            ...
            {
                companyViewModel.RelationTypeID = Convert.ToInt32(LovItemValue.Client);
        ...
        public ActionResult GetMasterAgreementByCompanyId(int companyId, int? page, int? limit, string sortBy, string direction, string searchString = null)
        {
            ...
            var typeId = Convert.ToInt32(LovItemValue.Client);
        ...
        public ActionResult AddUpdateCompanyMasterAgreement()
        {
            ...
            documentViewModel.TypeId = Convert.ToInt32(LovItemValue.Client);
